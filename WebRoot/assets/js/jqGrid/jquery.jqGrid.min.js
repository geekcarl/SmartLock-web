	...
	b.extend(b.jgrid, {
		...
		parseDate: function(d, f, c, e) {
			var a = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/,
				j = "string" === typeof f ? f.match(a) : null,
				a = function(a, b) {
					a = "" + a;
			...
			if (f && null != f) if (!isNaN(f - 0) && "u" === ("" + d).toLowerCase()) h = new Date(1E3 * parseFloat(f));
			else if (f.constructor === Date) h = f;
			else if (null !== j) h = new Date(parseInt(j[1], 10)), j[3] && (d = 60 * Number(j[5]) + Number(j[6]), d *= "-" === j[4] ? 1 : -1, d -= h.getTimezoneOffset(), h.setTime(Number(Number(h) + 6E4 * d)));
			else {
				f = ("" + f).replace(/\\T/g, "T").replace(/\\t/, "t").split(e.parseRe);
				d = d.replace(/\\T/g, "T").replace(/\\t/, "t").split(e.parseRe);
				i = 0;
				for (k = d.length; i < k; i++)"M" === d[i] && (j = b.inArray(f[i], e.monthNames), -1 !== j && 12 > j && (f[i] = j + 1, g.m = f[i])), "F" === d[i] && (j = b.inArray(f[i], e.monthNames, 12), -1 !== j && 11 < j && (f[i] = j + 1 - 12, g.m = f[i])), "a" === d[i] && (j = b.inArray(f[i], e.AmPm), -1 !== j && 2 > j && f[i] === e.AmPm[j] && (f[i] = j, g.h = h(f[i], g.h))), "A" === d[i] && (j = b.inArray(f[i], e.AmPm), -1 !== j && 1 < j && f[i] === e.AmPm[j] && (f[i] = j - 2, g.h = h(f[i], g.h))), "g" === d[i] && (g.h = parseInt(f[i], 10)), void 0 !== f[i] && (g[d[i].toLowerCase()] = parseInt(f[i], 10));
				g.f && (g.m = g.f);
		...
		from: function(d) {
			return new function(d, c) {
				...
				this._repeatCommand = function(a, b) {
					return null === k ? e : null !== a && null !== b ? k(a, b) : null === l || !A ? k(a) : k(l, a)
				};
				...
				this.contains = function(a, b) {
					A ? e._append(e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + '.indexOf("' + e._toStr(b) + '",0) > -1') : e._append(e._getStr("this") + '.indexOf("' + e._toStr(a) + '",0) > -1');
						...
						populateVisible: function() {
							...
							if (a) {
								...
								if (f) {
									...
									if (F && (!e.lastpage || !(z > e.lastpage || 1 === e.lastpage || z === e.page && z === e.lastpage))) c.hDiv.loading ? c.timer = setTimeout(c.populateVisible, e.scrollTimeout) : (e.page = z, y && (c.selectionPreserver(d[0]), c.emptyRows.call(d[0], !1, !1)), c.populate(F))
								}
							}
						},
					...
					if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
						...
						var o = function(a, b) {
							...
							n = function(d, e, g, f, h, i) {
								...
								else if (R.cellattr && b.isFunction(R.cellattr)) if ((d = R.cellattr.call(a, h, g, f, R, i)) && typeof d === "string") {
							...
							X = function(c, d, e, g, f, h) {
								...
								if (!b.isEmptyObject(h)) {
									...
									for (k in h) h.hasOwnProperty(k) && (i = i + (" " + k + "=" + h[k]))
								}
								...
								if (b.isXMLDoc(c)) {
									...
									if (c && w) {
										...
										for (; L < w;) {
											...
											if (i.repeatitems) {
												E || (E = U(s + u + m));
												var N = b.jgrid.getXmlData(x, i.cell, true);
												b.each(E, function(b) {
													var c = N[this];
													if (!c) return false;
							...
							ka = function(c, d) {
								...
								l = c + "_center";
								m = c + "_right";
								b("#" + b.jgrid.jqID(c)).append("<div id='" + j + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='" + k + "' align='left'></td><td id='" + l + "' align='center' style='white-space:pre;'></td><td id='" + m + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr");
								...
								f === "rtl" && (g = g + i);
								a.p.pginput === true && (e = "<td dir='" + f + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + b.jgrid.jqID(c) + "'></span>") + "</td>");
								if (a.p.pgbuttons === true) {
									...
									g = g + (e !== "" ? "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" + e + "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" : "") + ("<td id='" + k[2] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-next'></span></td>");
								...
								if (a.p.pgbuttons === true) {
									...
									b("#first" + b.jgrid.jqID(d) + ", #prev" + b.jgrid.jqID(d) + ", #next" + b.jgrid.jqID(d) + ", #last" + b.jgrid.jqID(d)).click(function() {
										...
										else if (c > 1 && b >= 1) if (b === 1) f = g = false;
										else {
											if (b === c) i = h = false
										} else if (c > 1 && b === 0) {
											i = h = false;
						...
						W = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + W + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + f + "'></span>" + ("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + oa + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + f + "'></span></span>");
						if (a.p.multiSort) {
							ba = a.p.sortname.split(",");
							for (g = 0; g < ba.length; g++) C = b.trim(ba[g]).split(" "), ba[g] = b.trim(C[0]), pa[g] = C[1] ? b.trim(C[1]) : a.p.sortorder || "asc"
						}
						for (g = 0; g < this.p.colNames.length; g++) C = a.p.headertitles ? ' title="' + b.jgrid.stripHtml(a.p.colNames[g]) + '"' : "", B += "<th id='" + a.p.id + "_" + a.p.colModel[g].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" + f + "'" + C + ">", C = a.p.colModel[g].index || a.p.colModel[g].name, B += "<div id='jqgh_" + a.p.id + "_" + a.p.colModel[g].name + "' " + na + ">" + a.p.colNames[g], a.p.colModel[g].width = a.p.colModel[g].width ? parseInt(a.p.colModel[g].width, 10) : 150, "boolean" !== typeof a.p.colModel[g].title && (a.p.colModel[g].title = !0), a.p.colModel[g].lso = "", C === a.p.sortname && (a.p.lastsort = g), a.p.multiSort && (C = b.inArray(C, ba), -1 !== C && (a.p.colModel[g].lso = pa[C])), B += W + "</div></th>";
						W = null;
						...
						(function() {
							var d = 0,
								e = b.jgrid.cell_width ? 0 : o(a.p.cellLayout, 0),
								g = 0,
						...
						var B = b("thead:first", a).get(0),
							Q = "";
						a.p.footerrow && (Q += "<table role='grid' style='width:" + a.p.tblwidth + "px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-" + f + "'>");
						var i = b("tr:first", B),
						...
						b(a).before(c.hDiv).click(function(c) {
							...
							if (b(p).length === 0 || p[0].className.indexOf("ui-state-disabled") > -1 || (b(v, a).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== a.id) return this;
							...
							if (!(v.tagName === "A" || (v.tagName === "INPUT" || v.tagName === "TEXTAREA" || v.tagName === "OPTION" || v.tagName === "SELECT") && !d) && e === true) {
								...
								if (a.p.cellEdit === true) if (a.p.multiselect && d) b(a).jqGrid("setSelection", w, true, c);
								else {
									w = p[0].rowIndex;
									try {
										b(a).jqGrid("editCell", w, I, true)
									} catch (g) {}
								} else if (a.p.multikey) if (c[a.p.multikey]) b(a).jqGrid("setSelection", w, true, c);
								else {
									if (a.p.multiselect && d) {
										d = b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + w).is(":checked");
										b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + w)[a.p.useProp ? "prop" : "attr"]("checked", d)
									}
								} else {
									if (a.p.multiselect && a.p.multiboxonly && !d) {
										...
										b(a.p.selarrrow).each(function(c, d) {
											...
											if (f) {
												...
												b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(f))[a.p.useProp ? "prop" : "attr"]("checked", false)
											}
										});
										a.p.selarrrow = []
									}
							...
							if (b(p).length !== 0) {
								...
								b.isFunction(a.p.ondblClickRow) && a.p.ondblClickRow.call(a, b(p).attr("id"), w, I, c)
							}
						...
						a.p.toolbar[0] && (c.uDiv = document.createElement("div"), "top" === a.p.toolbar[1] ? b(c.uDiv).insertBefore(c.hDiv) : "bottom" === a.p.toolbar[1] && b(c.uDiv).insertAfter(c.hDiv), "both" === a.p.toolbar[1] ? (c.ubDiv = document.createElement("div"), b(c.uDiv).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id).insertBefore(c.hDiv), b(c.ubDiv).addClass("ui-userdata ui-state-default").attr("id", "tb_" + this.id).insertAfter(c.hDiv), H && b(c.ubDiv).hide()) : b(c.uDiv).width(c.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id), H && b(c.uDiv).hide());
						...
						a.p.footerrow && (c.sDiv = b("<div class='ui-jqgrid-sdiv'></div>")[0], g = b("<div class='ui-jqgrid-hbox" + ("rtl" === f ? "-rtl" : "") + "'></div>"), b(c.sDiv).append(g).width(c.width).insertAfter(c.hDiv), b(g).append(Q), c.footers = b(".ui-jqgrid-ftable", c.sDiv)[0].rows[0].cells, a.p.rownumbers && (c.footers[0].className = "ui-state-default jqgrid-rownum"), H && b(c.sDiv).hide());
						g = null;
						if (a.p.caption) {
							var ta = a.p.datatype;
			...
			return this.each(function() {
				...
				if (void 0 !== d) {
					...
					if (f.p.multiselect) {
						...
						if (a) b("#jqg_" + b.jgrid.jqID(f.p.id) + "_" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(a))[f.p.useProp ? "prop" : "attr"]("checked", !1);
						f.setHeadCheckBox(!1)
					}
					e = null
				...
				}), f.setHeadCheckBox(!1), f.p.selarrrow = []) : f.p.selrow && (b("#" + b.jgrid.jqID(f.p.id) + " tbody:first tr#" + b.jgrid.jqID(f.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected", "false"), a && b("#" + b.jgrid.jqID(f.p.selrow), "#" + b.jgrid.jqID(a)).removeClass("ui-state-highlight"), f.p.selrow = null);
			...
			this.each(function() {
				...
				if (f) try {
					if (b(this.p.colModel).each(function(a) {
						...
						void 0 !== c && (l[e] = this.formatter && "string" === typeof this.formatter && "date" === this.formatter ? b.unformat.date.call(g, c, this) : c, h = g.formatter(d, c, a, f, "edit"), j = this.title ? {
		...
		footerData: function(d, f, c) {
			...
			this.each(function() {
				...
				b(this.p.colModel).each(function(e) {
					...
					} : {}, b("tr.footrow td:eq(" + e + ")", i.grid.sDiv).html(k).attr(h), j = !0) : "get" === d && (g[a] = b("tr.footrow td:eq(" + e + ")", i.grid.sDiv).html())
				})
			});
			return "get" === d ? g : j
		},
				...
				if (this.grid) {
					...
					if (!isNaN(d)) {
						...
						if (!0 === f) {
							...
							c.p.tblwidth = a;
							l = d - j * h - o;
							if (!isNaN(c.p.height) && (b(c.grid.bDiv)[0].clientHeight < b(c.grid.bDiv)[0].scrollHeight || 1 === c.rows.length)) i = !0, l -= k;
							var a = 0,
							...
							if (!g) return;
							n = 0;
							i ? d - o - (a + j * h) !== k && (n = d - o - (a + j * h) - k) : 1 !== Math.abs(d - o - (a + j * h)) && (n = d - o - (a + j * h));
			...
			return this.each(function() {
				...
				if (this.grid && (isNaN(f) ? b(this.p.colModel).each(function(a) {
					...
					if ("" !== c || !0 === j) h = this.formatter(d, c, g, h, "edit"), i = this.p.colModel[g].title ? {
						title: b.jgrid.stripHtml(h)
					} : {}, this.p.treeGrid && 0 < b(".tree-wrap", b(k)).length ? b("span", b(k)).html(h).attr(i) : b(k).html(h).attr(i), "local" === this.p.datatype && (h = this.p.colModel[g], c = h.formatter && "string" === typeof h.formatter && "date" === h.formatter ? b.unformat.date.call(this, c, h) : c, i = this.p._index[b.jgrid.stripPref(this.p.idPrefix, d)], void 0 !== i && (this.p.data[i][h.name] = c));
			...
			return this.each(function() {
				...
				b(c).keydown(function(d) {
					...
					if (a) if (h = c.p._index[b.jgrid.stripPref(c.p.idPrefix, a.id)], 37 === d.keyCode || 38 === d.keyCode || 39 === d.keyCode || 40 === d.keyCode) {
						...
						37 === d.keyCode && (c.p.treeGrid && c.p.data[h][i] && b(a).find("div.treeclick").trigger("click"), b(c).triggerHandler("jqGridKeyLeft", [c.p.selrow]), b.isFunction(f.onLeftKey) && f.onLeftKey.call(c, c.p.selrow));
		...
		if (d) {
			...
			if (a.fmatter.isString(d)) {
				var i = d.split(g),
					k = 0,
					l;
				for (l = 0; l < i.length; l++) if (g = i[l].split(f), 2 < g.length && (g[1] = a.map(g, function(a, b) {
					if (b > 0) return a
	...
	a.jgrid.extend({
		...
		sortGrid: function(a, c, f) {
			return this.each(function() {
				...
				if (this.grid) {
					a || (a = this.p.sortname);
					for (j = 0; j < this.p.colModel.length; j++) if (this.p.colModel[j].index === a || this.p.colModel[j].name === a) {
						g = j;
						break
				...
				if (!this.ftoolbar) {
					var f = function() {
							...
							a.each(c.p.colModel, function() {
								...
								n = b.searchOperators ? i.parent().prev().children("a").attr("soper") || b.defaultSearch : this.searchoptions && this.searchoptions.sopt ? this.searchoptions.sopt[0] : "select" === this.stype ? "eq" : b.defaultSearch;
						...
						g = function(e, d, j) {
							...
							for (i = 0; i < k.sopt.length; i++) n = a.inArray(k.sopt[i], h), -1 !== n && (l = j === b.odata[n].oper ? "ui-state-highlight" : "", d += '<li class="ui-menu-item ' + l + '" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="' + b.odata[n].oper + '" oper="' + b.operands[b.odata[n].oper] + '"><table cellspacing="0" cellpadding="0" border="0"><tr><td width="25px">' + b.operands[b.odata[n].oper] + "</td><td>" + b.odata[n].text + "</td></tr></table></a></li>");
							a("body").append(d + "</ul>");
					...
					a.each(c.p.colModel, function() {
						...
						if (this.search) {
							if (b.searchOperators) {
								...
								g = "<a title='" + (null != d.searchtitle ? d.searchtitle : b.operandTitle) + "' style='padding-right: 0.5em;' soper='" + g + "' class='soptclass' colname='" + this.name + "'>" + l + "</a>"
							}
							...
							case "select":
								if (g = this.surl || d.dataUrl) a.ajax(a.extend({
									...
									var m, r, o;
									e.searchoptions ? (m = void 0 === e.searchoptions.value ? "" : e.searchoptions.value, r = void 0 === e.searchoptions.separator ? ":" : e.searchoptions.separator, o = void 0 === e.searchoptions.delimiter ? ";" : e.searchoptions.delimiter) : e.editoptions && (m = void 0 === e.editoptions.value ? "" : e.editoptions.value, r = void 0 === e.editoptions.separator ? ":" : e.editoptions.separator, o = void 0 === e.editoptions.delimiter ? ";" : e.editoptions.delimiter);
									if (m) {
										...
										} else if ("object" === typeof m) for (q in m) m.hasOwnProperty(q) && (o = document.createElement("option"), o.value = q, o.innerHTML = m[q], l.appendChild(o));
...
(function(a) {
	a.extend(a.jgrid, {
		...
		info_dialog: function(d, b, c, g) {
			...
			a.fn.jqm && !h && (h = !1);
			d = "";
			if (0 < e.buttons.length) for (g = 0; g < e.buttons.length; g++) void 0 === e.buttons[g].id && (e.buttons[g].id = "info_button_" + g), d += "<a href='javascript:void(0)' id='" + e.buttons[g].id + "' class='fm-button ui-state-default ui-corner-all'>" + e.buttons[g].text + "</a>";
				...
				if (void 0 !== b.dataUrl) d = b.name ? ("" + b.id).substring(0, ("" + b.id).length - ("" + b.name).length - 1) : "" + b.id, g = b.postData || e.postData, i.p && i.p.idPrefix ? d = a.jgrid.stripPref(i.p.idPrefix, d) : g = void 0, a.ajax(a.extend({
					...
					if ("string" === typeof b.value) {
						...
						for (j = 0; j < n.length; j++) {
							...
							if (d && (-1 < a.inArray(a.trim(k[1]), g) || -1 < a.inArray(a.trim(k[0]), g))) e.selected = "selected"
						}
				...
				if (e.grid) {
					...
					if (void 0 !== a("#" + a.jgrid.jqID(u.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(+e.p.id)));
						...
						var n = a.extend([], e.p.colModel),
							x = "<a href='javascript:void(0)' id='" + i + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + b.Find + "</a>",
						...
						b.layer ? a.jgrid.createModal(u, m, b, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0], "#" + a.jgrid.jqID(b.layer), {
							position: "relative"
						}) : a.jgrid.createModal(u, m, b, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0]);
			...
			return this.each(function() {
					...
					a(e.p.colModel).each(function(r) {
						...
						if ("cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
							if (!1 === q) i = "";
								...
								try {
									i = a.unformat.call(e, a("td[role='gridcell']:eq(" + r + ")", e.rows[q]), {
										rowId: c,
										colModel: this
									}, r)
								} catch (t) {
							...
							a.isFunction(v.custom_value) && "_empty" !== c && v.custom_value.call(d, a("#" + h, "#" + f), "set", i);
						...
						o && (a('td[role="gridcell"]', o).each(function(j) {
							...
							if ("cb" !== l && "subgrid" !== l && "rn" !== l && !0 === m[j].editable) {
								...
								case "checkbox":
									...
									else a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]({
										checked: !1,
										defaultChecked: !1
									});
								...
								case "custom":
									try {
										if (m[j].editoptions && a.isFunction(m[j].editoptions.custom_value)) m[j].editoptions.custom_value.call(d, a("#" + l, "#" + f), "set", g);
										else throw "e1";
									} catch (p) {
				...
				function s() {
					var e, l = [!0, "", ""],
						g = {},
						h = d.p.prmNames,
						i, m, r, o, n, z = a(d).triggerHandler("jqGridAddEditBeforeCheckValues", [a("#" + f), v]);
					...
					if (l[0] && !b[d.p.id].processing) {
						...
						if (!0 === d.p.treeGrid) for (n in j[m] === h.addoper && (o = a(d).jqGrid("getGridParam", "selrow"), j["adjacency" === d.p.treeGridModel ? d.p.treeReader.parent_id_field : "parent_id"] = o), d.p.treeReader) d.p.treeReader.hasOwnProperty(n) && (g = d.p.treeReader[n], j.hasOwnProperty(g) && !(j[m] === h.addoper && "parent_id_field" === n) && delete j[g]);
							...
							complete: function(g, r) {
								...
								if (l[0] === false) {
									...
									if (j[m] === h.addoper) {
										...
										} else b[d.p.id].clearAfterAdd && t("_empty", d, f)
									} else {
				...
				function n(c, b) {
					...
					c === d ? a("#nData", k + "_2").addClass("ui-state-disabled") : void 0 !== b[1][c + 1] && a("#" + a.jgrid.jqID(b[1][c + 1])).hasClass("ui-state-disabled") ? a("#nData", k + "_2").addClass("ui-state-disabled") : a("#nData", k + "_2").removeClass("ui-state-disabled")
				}
				function x() {
				...
				if (d.grid && r) {
					...
					if (void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
						...
						b[d.p.id].bottominfo ? (a(".bottominfo", k + "_2").html(b[d.p.id].bottominfo), a(".binfo", k + "_2").show()) : a(".binfo", k + "_2").hide();
						t(r, d, f);
						...
						var l = "<a href='javascript:void(0)' id='" + l + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
							...
							o = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + o + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (w ? D + l : l + D) + "</td><td class='EditButton'>" + H + I + "</td></tr>" + ("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>" + b[d.p.id].bottominfo + "</td></tr>"),
							o = o + "</tbody></table>";
						if (0 < F) {
							var J = [];
						...
						a.jgrid.createModal(p, o, c, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0]);
						...
						!0 === c.saveicon[0] && a("#sData", k + "_2").addClass("right" === c.saveicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + c.saveicon[2] + "'></span>");
						...
						a("#sData", k + "_2").click(function() {
							...
							else if (c.checkOnSubmit === true) if (K = m(j, b[d.p.id]._savedData)) {
			...
			return this.each(function() {
				...
				if (m.grid && r) {
					...
					if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) {
						...
						x = a("<div></div>").append(x).append("<table border='0' class='EditTable' id='" + n + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + c.labelswidth + "'>" + (d ? o + f : f + o) + "</td><td class='EditButton'>" + y + "</td></tr></tbody></table>");
						...
						a("#dData", "#" + g + "_2").click(function() {
							...
							if (f[0] && !b[e.p.id].processing) {
								...
								h = a.extend({
									...
									type: b[e.p.id].mtype,
									data: a.isFunction(b[e.p.id].serializeDelData) ? b[e.p.id].serializeDelData.call(e, n) : n,
									complete: function(d, h) {
										...
										if (f[0] === false) {
											...
											if (b[e.p.id].reloadAfterSubmit && e.p.datatype !== "local") a(e).trigger("reloadGrid");
												...
												} catch (p) {} else for (k = 0; k < i.length; k++) a(e).jqGrid("delRowData", e.p.idPrefix + i[k]);
												e.p.selrow = null;
												e.p.selarrrow = []
											}
								...
								if (!h.url && !b[e.p.id].useDataProxy) if (a.isFunction(e.p.dataProxy)) b[e.p.id].useDataProxy = true;
								else {
									f[0] = false;
					...
					if (h.grid && "string" === typeof b) {
						...
						for (x = 0; x < n; x++) {
							var f = a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
								o, k;
							0 === x ? (o = b, k = h.p.id, o === h.p.toppager && (k += "_top", n = 1)) : (o = h.p.toppager, k = h.p.id + "_top");
							...
							c.del && (g = a("<td class='ui-pg-button ui-corner-all'></td>"), t = t || {}, a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.delicon + "'></span>" + c.deltext + "</div>"), a("tr", f).append(g), a(g, f).attr({
								...
								if (!a(this).hasClass("ui-state-disabled")) {
									...
									a.isFunction(c.delfunc) ? c.delfunc.call(h, b) : a(h).jqGrid("delGridRow", b, t);
								}
								return false
							}).hover(d, q), g = null);
	...
	a.fn.jqFilter = function(d) {
		...
		return this.each(function() {
			if (!this.filter) {
				...
				if (l) {
					for (d = 0; d < l; d++) if (f = this.p.columns[d], f.stype ? f.inputtype = f.stype : f.inputtype || (f.inputtype = "text"), f.sorttype ? f.searchtype = f.sorttype : f.searchtype || (f.searchtype = "string"), void 0 === f.hidden && (f.hidden = !1), f.label || (f.label = f.name), f.index && (f.name = f.index), f.hasOwnProperty("searchoptions") || (f.searchoptions = {}), !f.hasOwnProperty("searchrules")) f.searchrules = {};
					...
					this.createTableForGroup = function(g, j) {
						...
						if (void 0 !== g.groups) for (c = 0; c < g.groups.length; c++) e = a("<tr></tr>"), k.append(e), h = a("<td class='first'></td>"), e.append(h), h = a("<td colspan='4'></td>"), h.append(this.createTableForGroup(g.groups[c], g)), e.append(h);
					...
					this.createTableRowForRule = function(g, j) {
						...
						l.bind("change", function() {
							...
							if (i) {
								...
								a.jgrid.msie && 9 > a.jgrid.msiever() && (j = parseInt(a("select.selectopts", f)[0].offsetWidth, 10) + 1, a(".selectopts", f).width(j), a(".selectopts", f).css("width", "auto"));
...
(function(a) {
	...
	a.jgrid.extend({
		...
		saveRow: function(c, b, e, o, l, g, n) {
			...
			else if (a.isFunction(b) && (f.successfunc = b), void 0 !== e && (f.url = e), void 0 !== o && (f.extraparam = o), a.isFunction(l) && (f.aftersavefunc = l), a.isFunction(g) && (f.errorfunc = g), a.isFunction(n)) f.afterrestorefunc = n;
			var f = a.extend(!0, {
				successfunc: null,
				url: null,
				extraparam: {},
					...
					complete: function(b, g) {
						...
						if ("success" === g) {
							...
							if (!0 === e) {
								...
								a(q).attr("editable", "0");
								for (e = 0; e < d.p.savedRow.length; e++) if ("" + d.p.savedRow[e].id === "" + c) {
									t = e;
									break
								}
								0 <= t && d.p.savedRow.splice(t, 1);
		...
		restoreRow: function(c, b) {
			var e = a.makeArray(arguments).slice(1),
				o = {};
			"object" === a.type(e[0]) ? o = e[0] : a.isFunction(b) && (o.afterrestorefunc = b);
	...
	d.jgrid.extend({
		groupingSetup: function() {
			return this.each(function() {
				...
				if (null !== a && ("object" === typeof a || d.isFunction(a))) if (a.groupField.length) {
					void 0 === a.visibiltyOnNextGrouping && (a.visibiltyOnNextGrouping = []);
					a.lastvalues = [];
					a.groups = [];
					a.counters = [];
					for (b = 0; b < a.groupField.length; b++) a.groupOrder[b] || (a.groupOrder[b] = "asc"), a.groupText[b] || (a.groupText[b] = "{0}"), "boolean" !== typeof a.groupColumnShow[b] && (a.groupColumnShow[b] = !0), "boolean" !== typeof a.groupSummary[b] && (a.groupSummary[b] = !1), !0 === a.groupColumnShow[b] ? (a.visibiltyOnNextGrouping[b] = !0, d(this).jqGrid("showCol", a.groupField[b])) : (a.visibiltyOnNextGrouping[b] = d("#" + d.jgrid.jqID(this.p.id + "_" + a.groupField[b])).is(":visible"), d(this).jqGrid("hideCol", a.groupField[b]));
					a.summary = [];
					b = 0;
		...
		groupingPrepare: function(b, g, f, a) {
			this.each(function() {
				var e = this.p.groupingView,
					...
					l, j, m, q = 0;
				for (c = 0; c < k; c++) l = e.groupField[c], m = e.displayField[c], j = f[l], m = null == m ? null : f[m], null == m && (m = j), void 0 !== j && (0 === a ? (e.groups.push({
					idx: c,
					dataIndex: l,
					value: j,
					displayValue: m,
					...
					this.v = d.isFunction(this.st) ? this.st.call(h, this.v, this.nm, f) : d(h).jqGrid("groupingCalculations.handler", this.st, this.v, this.nm, this.sr, this.srt, f)
			...
			this.each(function() {
				...
				if (k.hasClass(e)) {
					if (g.showSummaryOnHide) {
						if (c) for (; c && !(d(c).hasClass("jqfoot") && parseInt(d(c).attr("jqfootlevel"), 10) <= a);) d(c).hide(), c = c.nextSibling
					} else if (c) for (; c;) {
		...
		groupingRender: function(b, g) {
			return this.each(function() {
				...
				d.each(a.p.colModel, function(a, c) {
					var b;
					for (b = 0; b < w; b++) if (e.groupField[b] === c.name) {
						q[b] = a;
						break
					}
				});
				...
				d.each(e.groups, function(s, i) {
					...
					try {
						d.isArray(e.formatDisplayField) && d.isFunction(e.formatDisplayField[i.idx]) && (i.displayValue = e.formatDisplayField[i.idx].call(a, i.displayValue, i.value, a.p.colModel[q[i.idx]], i.idx, e)), m = a.formatter(k, i.displayValue, q[i.idx], i.value)
					} catch (C) {
						m = i.displayValue
					}
		...
		groupingGroupBy: function(b, g) {
			return this.each(function() {
				...
				var a;
				for (a = 0; a < f.groupField.length; a++)!f.groupColumnShow[a] && f.visibiltyOnNextGrouping[a] && d(this).jqGrid("showCol", f.groupField[a]);
		...
		groupingRemove: function(b) {
			return this.each(function() {
				...
				if (!0 === b) {
					var g = this.p.groupingView,
						f;
					for (f = 0; f < g.groupField.length; f++)!g.groupColumnShow[f] && g.visibiltyOnNextGrouping[f] && d(this).jqGrid("showCol", g.groupField);
		...
		groupingCalculations: {
			handler: function(b, d, f, a, e, h) {
				var c = {
					...
					max: function() {
						return "" === d ? parseFloat(h[f] || 0) : Math.max(parseFloat(d), parseFloat(h[f] || 0))
					},
					count: function() {
						"" === d && (d = 0);
...
(function(d) {
	d.jgrid.extend({
		setTreeNode: function(b, c) {
			return this.each(function() {
				var a = this;
				if (a.grid && a.p.treeGrid) for (var h = a.p.expColInd, e = a.p.treeReader.expanded_field, i = a.p.treeReader.leaf_field, g = a.p.treeReader.level_field, f = a.p.treeReader.icon_field, l = a.p.treeReader.loaded, k, m, n, j; b < c;) j = d.jgrid.stripPref(a.p.idPrefix, a.rows[b].id), j = a.p.data[a.p._index[j]], "nested" === a.p.treeGridModel && !j[i] && (k = parseInt(j[a.p.treeReader.left_field], 10), m = parseInt(j[a.p.treeReader.right_field], 10), j[i] = m === k + 1 ? "true" : "false", a.rows[b].cells[a.p._treeleafpos].innerHTML = j[i]), k = parseInt(j[g], 10), 0 === a.p.tree_root_level ? (n = k + 1, m = k) : (n = k, m = k - 1), n = "<div class='tree-wrap tree-wrap-" + a.p.direction + "' style='width:" + 18 * n + "px;'>", n += "<div style='" + ("rtl" === a.p.direction ? "right:" : "left:") + 18 * m + "px;' class='ui-icon ", void 0 !== j[l] && (j[l] = "true" === j[l] || !0 === j[l] ? !0 : !1), "true" === j[i] || !0 === j[i] ? (n += (void 0 !== j[f] && "" !== j[f] ? j[f] : a.p.treeIcons.leaf) + " tree-leaf treeclick", j[i] = !0, m = "leaf") : (j[i] = !1, m = ""), j[e] = ("true" === j[e] || !0 === j[e] ? !0 : !1) && (j[l] || void 0 === j[l]), n = !1 === j[e] ? n + (!0 === j[i] ? "'" : a.p.treeIcons.plus + " tree-plus treeclick'") : n + (!0 === j[i] ? "'" : a.p.treeIcons.minus + " tree-minus treeclick'"), n += "></div></div>", d(a.rows[b].cells[h]).wrapInner("<span class='cell-wrapper" + m + "'></span>").prepend(n), k !== parseInt(a.p.tree_root_level, 10) && ((j = (j = d(a).jqGrid("getNodeParent", j)) && j.hasOwnProperty(e) ? j[e] : !0) || d(a.rows[b]).css("display", "none")), d(a.rows[b].cells[h]).find("div.treeclick").bind("click", function(b) {
					...
					var b = d.jgrid.stripPref(a.p.idPrefix, d(b.target || b.srcElement, a.rows).closest("tr.jqgrow")[0].id),
						c = a.p._index[b];
				...
				if (this.grid && this.p.treeGrid) {
					...
					if (!b[c]) {
						var f = d.jgrid.getAccessor(b, this.p.localReader.id),
							...
							k = this.p._index[f];
						d(this).jqGrid("isNodeLoaded", this.p.data[k]) ? (b[c] = !0, d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus")) : this.grid.hDiv.loading || (b[c] = !0, d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"), this.p.treeANode = l.rowIndex, this.p.datatype = this.p.treedatatype, "nested" === this.p.treeGridModel ? d(this).jqGrid("setGridParam", {
							postData: {
								nodeid: f,
								n_left: b[i],
								n_right: b[g],
