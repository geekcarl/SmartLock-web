...
<html lang="en">
	...
	<body   oncontextmenu="return false">
		...
		<input type="hidden" value="${boxevent_export }" id="boxevent_export">
			...
			<div style="padding:10px 50px 20px 50px">
				<form id="d_search_form">
					<table width="100%" cellpadding="5" height="auto">
						...
						<tr>
							<td>开门时间：</td>
							<td><input type="text"  id="s_open_time" name="s_open_time" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/></td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>开门钥匙：</td>
						...
						<tr>
							<td>关门时间：</td>
							<td><input type="text"  id="s_close_time" name="s_close_time" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/></td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>关门钥匙：</td>
						...
						<tr>
							<td>关门RFID：</td>
							<td><input type="text"  id="s_close_rfids" value=""/></td>
							<td>&nbsp;</td>
						</tr>
					</table>
				</form>
