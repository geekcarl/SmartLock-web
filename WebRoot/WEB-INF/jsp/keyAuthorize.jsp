...
<html lang="en">
	...
	<body   oncontextmenu="return false">
		...
		<input type="hidden" value="${keyAuthorize_add }" id="keyAuthorize_add">
		<input type="hidden" value="${keyAuthorize_view }" id="keyAuthorize_view">
		<input type="hidden" value="${keyAuthorize_update }" id="keyAuthorize_update">
		<input type="hidden" value="${keyAuthorize_delete }" id="keyAuthorize_delete">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="well well-sm">
									...
									<input id="f_s_key_rfid" type="text" placeholder="钥匙编号"/>-
									<input id="f_s_key_code" type="text" placeholder="钥匙内码"/>-
									<input id="f_s_operator_name" type="text" placeholder="使用人姓名"/>
			 ...
			 <div style="padding:10px 50px 20px 50px">
		        <form id="form-update-grant" method="post">
		        	<table cellpadding="5" width="100%">
		                ...
		                <tr>
		                    <td>权限时间:</td>
		                    <td colspan="2">
		                    	<input type="text" id="u_grant_begin_time" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
		                    	至
		                    	<input type="text" id="u_grant_end_time"  value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
		                    </td>
		                </tr>
		        	</table>
		        </form>
		        <div style="width:100%; margin-top:20px; margin-bottom:20px;">
			        <div style="width:250px; height:400px; overflow:auto; border:1px solid black; float: left; text-align: center; padding-top:7px;  margin-left:30px;">
				                     选择钥匙(单选)<font style="color:red;">*</font>
		...
		<div id="dialog-view" class="hide">
			 <div style="padding:10px 50px 20px 50px">
				<table width="100%" class="table table-striped table-bordered table-hover js-table" >
					...
					<tr>
						<td>钥匙编号：</td>
						<td><span id="view_key_no"></span></td>
					</tr>
					<!-- <tr>
						<td>钥匙内码：</td>
		        ...
		        <form id="form-add-grant">
		        	<table cellpadding="5" width="100%">
		                ...
		                <tr>
		                    <td>权限时间:</td>
		                    <td colspan="2">
		                    	<input type="text" id="a_grant_begin_time" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
		                    	至
		                    	<input type="text" id="a_grant_end_time"  value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
		                    </td>
		                </tr>
		        	</table>
		        </form>
