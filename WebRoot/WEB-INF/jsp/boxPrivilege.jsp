...
<html lang="en">
	...
	<body   oncontextmenu="return false">
		...
		<input type="hidden" value="${boxprivilege_add }" id="boxprivilege_add">
		<input type="hidden" value="${boxprivilege_delete }" id="boxprivilege_delete">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
	                             <div class="well well-sm">
									...
									<input id="f_s_full_name" type="text" placeholder="人员姓名"/>
		...
		<div id="dialog-add-grant" class="hide">
			 <div style="padding:10px 50px 20px 50px">
		        <div style="width:100%; margin-top:20px; margin-bottom:20px;">
			        <div style="width:300px; height:400px; overflow:auto; border:1px solid black;  float: left; text-align: center; padding-top:7px; margin-left:30px;">
			        	选择光交箱(多选)<font style="color:red;">*</font>
		...
		<script src="js/boxPrivilege.js"></script>
