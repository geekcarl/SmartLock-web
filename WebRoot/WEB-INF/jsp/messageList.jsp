...
<html lang="en">
	...
	<body   oncontextmenu="return false">
		...
		<input type="hidden" value="${message_delete }" id="message_delete">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="well well-sm">
									接收人姓名：<input id="f_s_full_name" type="text" placeholder="姓名"/> 
									告警时间：<input type="text" id="f_s_create_date" name="f_s_create_date"  value="" placeholder="告警时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
