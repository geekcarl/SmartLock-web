							...
							<div class="col-xs-12">
								...
								<div class="tabbable" id="box_tabs">
									<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4" style="height:50px !important;">
										<li class="active">
											<a data-toggle="tab" href="#door"><i class="icon-globe bigger-130"></i>开关记录</a>
										</li>
		
										<li>
											<a data-toggle="tab" href="#warn"><i class="icon-th bigger-130"></i>告警记录</a>
										</li>
										
										<li>
											<a data-toggle="tab" href="#used"><i class="icon-th bigger-130"></i>纤芯使用情况分析</a>
										</li>
									</ul>
									<div class="tab-content" id="box_tabs_content" style="display: none;">
										<div id="door" class="tab-pane in active" style="width:100%; height:100%;">
										</div>
		
										<div id="warn" class="tab-pane" style="width:100%; height:100%;">
										</div>
										
										<div id="used" class="tab-pane" style="width:100%; height:100%;">
										</div>
									</div>
								</div>
			...
			<div style="padding:10px 50px 20px 50px">
				<form>
					<table width="100%" height="auto">
						...
						<tr>
							<td>解除时间：</td>
							<td><input type="text" readonly="readonly" id="settled_time" value=""/></td>
						</tr>
						<tr>
							<td>解除钥匙：</td>
							<td><input type="text" readonly="readonly" id="settled_keys" value=""/></td>
						</tr>
						<tr>
							<td>解除人员：</td>
							<td><input type="text" readonly="readonly" id="settled_operators" value=""/></td>
						</tr>
						<tr>
							<td>解除RFID：</td>
							<td><input type="text" readonly="readonly" id="settled_rfids" value=""/></td>
						</tr>
						<tr>
							<td>是否已确认：</td>
