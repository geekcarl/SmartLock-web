...
<html lang="en">
	...
	<body   oncontextmenu="return false">
		...
		<input type="hidden" value="${role_add }" id="role_add">
		<input type="hidden" value="${role_update}" id="role_update">
		<input type="hidden" value="${role_delete}" id="role_delete">
		...
		<div id="dialog-a-role" class="hide">
			<div style="padding:10px 50px 20px 50px">
				<form>
					<table width="100%" height="auto">
						...
						<tr>
							<td>选择权限：</td>
							<td>
								<div id="a_tree_div" class="widget-main padding-8" style="width:400px; height:auto; border:1px solid #efefef;">
									<div id="a_tree" class="ztree"></div>
								</div>
							</td>
						</tr>
						<tr>
							<td>备注：</td>
							<td><textarea rows="5" cols="70"id="a_remark" name="a_remark"></textarea></td>
						</tr>
					</table>
				</form>
			</div>
		...
		<div id="dialog-u-role" class="hide">
			<div style="padding:10px 50px 20px 50px">
				<form>
					<table width="100%" height="auto">
						<tr>
						...
						<tr>
							<td>选择权限：</td>
							<td>
								<div id="u_tree_div" class="widget-main padding-8" style="width:400px; height:auto; border:1px solid #efefef;">
									<div id="u_tree" class="ztree"></div>
								</div>
							</td>
						</tr>
						<tr>
							<td>备注：</td>
							<td><textarea rows="5" cols="70"id="u_remark" name="u_remark"></textarea></td>
						</tr>
					</table>
				</form>
			</div>
